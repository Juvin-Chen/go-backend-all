...
**核心要点：**
- 1.Handler 是 Go 处理 HTTP 请求的核心接口（仅含 ServeHTTP 方法）
- 2.DefaultServeMux 是默认路由分发器（本质也是 Handler）
- 3.http.Server 是 Web 服务的核心配置载体，ListenAndServe 是其顶层封装
- 4.http.Handle / http.HandleFunc 是注册处理器到路由的核心方法
